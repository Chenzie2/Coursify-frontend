...
const LandingPage = () => {
  ...
  const courses = [
    ...
    { id: 10, title: 'Database Design', level: 'Intermediate', image: 'src/assets/Databasedesign.png' },
    { id: 11, title: 'DevOps Essentials', level: 'Advanced', image: 'src/assets/DevOps.png' },
    { id: 12, title: 'Cybersecurity Basics', level: 'Beginner', image: 'src/assets/Cybersecurity.png' }
  ];
